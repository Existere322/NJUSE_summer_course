...
> 这 30 分钟里，我们完成了一个完整 Agent Coding 闭环：提出需求、结构化 Prompt、Agent 创建项目、人工检查、本地预览、生成部署配置、Git 提交、push、GitHub Pages 发布。
...
学生课后完成一个自己的 GitHub Pages 小站，要求：

1. 使用 OpenCode 创建网站；
2. 至少包含 `index.html`、`style.css`、`script.js`；
3. 至少使用一次结构化 Prompt；
4. 至少截图三张：
   ...
   * GitHub Actions 部署成功；
   * GitHub Pages 网站访问成功；
5. 提交 GitHub 仓库链接和 Pages 访问链接；
6. 附一段 200 字反思：Agent 哪些地方做得好，哪些地方需要人工审查。
